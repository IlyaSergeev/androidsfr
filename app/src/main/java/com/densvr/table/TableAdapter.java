...
public abstract class TableAdapter {
	...
	protected TableFixHeaders pTableFixHeaders;
	
	
	public void setTableFixHeaders(TableFixHeaders pTableFixHeaders) {
	 ...
	 */
	public abstract int getItemViewType(int row, int column);
