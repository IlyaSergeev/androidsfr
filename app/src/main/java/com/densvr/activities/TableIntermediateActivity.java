...
public class TableIntermediateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonSave.setOnClickListener(v -> {
            ...
            MainActivity.makeText("результат сохранен", TableIntermediateActivity.this);
            TableIntermediateActivity.this.finish();
            startActivity(new Intent(TableIntermediateActivity.this, TableIntermediateActivity.class));
        });
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    if (!TableIntermediateActivity.this.chipData.isDisqualified()) {
                        ...
                        MainActivity.makeText("нельзя восстановить не снятого участника", TableIntermediateActivity.this);
                    } else {
                        MainActivity.makeText("участник будет восстановлен", TableIntermediateActivity.this);
                    }
                } else {
                    MainActivity.makeText("участник будет снят", TableIntermediateActivity.this);
                }
            }
        });
        ...
        binding.checkBoxOverwriteAttempt.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked) {
                    MainActivity.makeText("попытка будет добавлена без перезаписи", TableIntermediateActivity.this);
                } else {
                    MainActivity.makeText("попытка будет перезаписана", TableIntermediateActivity.this);
                }
            }
        });
