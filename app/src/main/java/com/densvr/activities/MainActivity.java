...
public class MainActivity extends ListActivity {
	...
	*/
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        com.densvr.androidsfr.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        ArrayAdapter<B> arrAdapter = new ArrayAdapter<B>(this, R.layout.listview_item, R.id.item_textView, b) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView textView = layout.findViewById(R.id.item_textView);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (textView.getText().equals("chip imitation")) {// chip imitation
            if (OldDistsProtocol.isThereAreNoDists()) {
                MainActivity.makeText("нет дистанций", this);
                return;
            }
    ...
    public void onResume() {
        ...
        if (nfcAdapter == null) {
            makeText("для работы программы включите NFC", this);
        }
    }
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
            ...
            if (tag != null && getCanReadSfrRecord(tag)) {
                try {
                    ...
                    ex.printStackTrace();
                    MainActivity.makeText("поднесите чип еще раз", this);
                }
            } else {
                MainActivity.makeText("поднесите чип еще раз", this);
            }
    ...
    private boolean onNewChipData() {
        if (OldGlobals.chipData.getCPs().size() == 0) {
            MainActivity.makeText("пустой чип", this);
            return false;
        }
