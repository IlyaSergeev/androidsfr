...
public class AboutActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("Приложение AndroidSFR, версия " + version + ", код " + code
				...
				+ "\nДля работы приложения необходимо создать на sd карте папку " + Globals.CSV_ADDRESS + " и включить NFC." 
				...
				+ "\nПротокол результатов, имена и дистанции хранятся в формате csv в папке" + Globals.CSV_ADDRESS + "."
				+ " \n"
