...
public class TableResultsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.densvr.androidsfr.databinding.ActivityTableResultsBinding binding = ActivityTableResultsBinding.inflate(getLayoutInflater());
                ...
                OldConfirmDialog.showDialog(TableResultsActivity.this, "Удалить все результаты?", "",
                        bResult -> {
                            if (bResult) {
                                ...
                                MainActivity.makeText("Все результаты были удалены", TableResultsActivity.this);
                                //TableResultsActivity.this.finish();
